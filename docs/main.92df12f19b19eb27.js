    ...
    29: () => {
        ...
        constructor(t, n, r, i) {
          ...
          rr(n)
            ...
            : n &&
              ...
              n !== no &&
                ((o = Object.create(n)),
                rr(o.unsubscribe) && this.add(o.unsubscribe.bind(o)),
      ...
      function $e(e, t, n = Number.POSITIVE_INFINITY) {
        return "function" == typeof t
          ? (r) =>
              r.pipe(
                $e((i, s) => ke(e(i, s)).pipe(ee((o, a) => t(i, o, s, a))), n)
              )
      ...
      function oC(e, t, n, r) {
        const i =
          ...
          l = o[a];
        (s[a] = new iC(l && l.currentValue, t, o === Or)), (e[r] = t);
      }
      Ln.ngInherit = !0;
      ...
      class Fb {
        ...
        getInertBodyElement(t) {
          ...
          if ("content" in n) return (n.innerHTML = Jr(t)), n;
          const r = this.inertDocument.createElement("body");
          return (
            (r.innerHTML = Jr(t)),
      ...
      function Sp(e, t) {
        ...
        try {
          ...
          return Jr(new jb().sanitizeChildren(Au(n) || n));
        } finally {
          if (n) {
            const r = Au(n) || n;
          ...
          if (!s) return !1;
          {
            ...
            if (!a) {
              ...
              t.push(
                ...
                { provide: Ru, useValue: () => M(i), multi: !0 }
              );
            }
            const l = s.providers;
            null == l ||
      ...
      class Fp extends Bn {
        constructor(t, n, r, i) {
          super(),
            ...
            this.records.set(Mp, Xr(void 0, this)),
            i.has("environment") && this.records.set(Bn, Xr(void 0, this));
          ...
          try {
            if (!(r & P.SkipSelf)) {
              ...
              if (void 0 === a) {
                ...
                (a = l && this.injectableDefInScope(l) ? Xr(Fu(t), Uo) : null),
        ...
        processProvider(t) {
          let n = cr((t = L(t))) ? t : L(t && t.provide);
          ...
          if (cr(t) || !0 !== t.multi) this.records.get(n);
          else {
      ...
      function rc(e, t, n, r, i, s, o) {
        for (; null != n; ) {
          ...
          if (
            ...
            if (8 & l) rc(e, t, n.child, r, i, s, !1), ri(t, e, i, a, s);
            else if (32 & l) {
              const u = Ku(n, r);
              let c;
              for (; (c = u()); ) ri(t, e, i, c, s);
              ri(t, e, i, a, s);
            } else 16 & l ? fg(e, t, r, n, i, s) : ri(t, e, i, a, s);
      ...
      function fg(e, t, n, r, i, s) {
        ...
        if (Array.isArray(l))
          for (let u = 0; u < l.length; u++) ri(t, e, i, l[u], s);
      ...
      let Nt = (() => {
        ...
        return (
          ...
          (e.NULL = new Rp()),
          (e.ɵprov = k({ token: e, providedIn: "any", factory: () => M(Mp) })),
      ...
      function I(e, t = P.Default) {
        const n = v();
        return null === n ? M(e, t) : Qh(Re(), n, L(e), t);
      }
      function uc() {
      ...
      function Xg(e, t, n, r, i) {
        e.data[r] = i;
        const s = i.factory || (i.factory = lr(i.type)),
          o = new Ui(s, Gt(i), I);
        (e.blueprint[r] = o),
          (n[r] = o),
          Qg(e, t, 0, r, oi(e, n, i.hostVars, H), i);
      }
      function s0(e, t, n) {
        const r = Rt(t, e),
          i = zg(n),
      ...
      class gs extends kp {
        ...
        create(t, n, r, i) {
          ...
          return new v0(this.componentType, m, ei(_, g), g, _);
        }
      }
      ...
      function ms(e) {
        return (
          !!Pc(e) && (Array.isArray(e) || (!(e instanceof Map) && fr() in e))
        );
      }
      function Pc(e) {
        ...
        return (
          (function Em(e, t, n, r, i, s, o, a) {
            ...
            if (h && null !== p && (g = p[i])) {
              ...
              if (m)
                for (let _ = 0; _ < m; _ += 2) {
                  const Y = t[g[_]][g[_ + 1]].subscribe(s),
                    ye = f.length;
                  f.push(s, Y), c && c.push(i, r.index, ye, -(ye + 1));
                }
            }
          })(s, i, i[W], o, e, t, 0, r),
          Un
      ...
      function Q(e, t = "") {
        const n = v(),
          r = Z(),
          i = e + 22,
          s = r.firstCreatePass ? si(r, i, 1, t, null) : r.data[i],
      ...
      function Ds(e, t, n) {
        const r = v(),
          i = (function li(e, t, n, r) {
            return qe(e, $r(), n) ? t + $(n) + r : H;
          })(r, e, t, n);
        return (
          i !== H &&
            (function bn(e, t, n) {
      ...
      function va(e, t) {
        return 4 & e.type ? new QM(t, e, ei(e, t)) : null;
      }
      let Jt = (() => {
        class e {}
      ...
      function rA(e, t, n, r) {
        return -1 === n
          ? (function nA(e, t) {
              return 11 & e.type ? ei(e, t) : 4 & e.type ? va(e, t) : null;
            })(t, e)
          : -2 === n
          ? (function iA(e, t, n) {
              return n === qt
        ...
        return (s = []) => {
          ...
          if (!o || o.injector.get(Hv, !1)) {
            ...
            e
              ? e(a)
              : (function $A(e) {
                  if (Gn && !Gn.get(Hv, !1)) throw new D(400, !1);
                  Gn = e;
                  const t = e.get(qv);
                  (function zv(e) {
                  ...
                  (function Gv(e = [], t) {
                    return Nt.create({
                      ...
                      providers: [
                        ...
                        { provide: pd, useValue: new Set([() => (Gn = null)]) },
                        ...e,
                      ],
                    });
                  })(a, r)
      ...
      let ja = (() => {
        ...
        return (
          (e.ɵfac = function (n) {
            return new (n || e)(I(Ma), I(Rs), I(qt), I(Wo));
          }),
          (e.ɵdir = Ve({
            type: e,
            selectors: [["", "ngClass", ""]],
      ...
      let Y_ = (() => {
          ...
          return (
            (e.ɵfac = function (n) {
              return new (n || e)(M(q_, 12));
            }),
            (e.ɵmod = Ze({ type: e })),
            (e.ɵinj = He({ providers: [...Q_, ...K_], imports: [Kn, aR] })),
            e
          );
        })(),
        Z_ = (() => {
            ...
            validateStyleProperty(n) {
              return (function pP(e) {
                Dr ||
                  ...
                  (hD = !!Dr.style && "WebkitAppearance" in Dr.style));
                let t = !0;
                return (
                  Dr.style &&
                    !(function hP(e) {
      ...
      class xP {
        ...
        visitGroup(t, n) {
          ...
          return (
            (n.currentTime = i), { type: 3, steps: s, options: Er(t.options) }
          );
        }
        visitAnimate(t, n) {
        ...
        visitAnimateChild(t, n) {
          return n.depCount++, { type: 9, options: Er(t.options) };
        }
        visitAnimateRef(t, n) {
          return {
            type: 10,
      ...
      class UP {
        ...
        _visitSubInstructions(t, n, r) {
          ...
          const o = null != r.duration ? Zn(r.duration) : null,
            a = null != r.delay ? Zn(r.delay) : null;
          return (
            0 !== o &&
              t.forEach((l) => {
        ...
        visitGroup(t, n) {
          ...
          const s = t.options && t.options.delay ? Zn(t.options.delay) : 0;
          t.steps.forEach((o) => {
      ...
      class df {
        ...
        updateOptions(t, n) {
          ...
          const r = t;
          let i = this.options;
          null != r.duration && (i.duration = Zn(r.duration)),
            null != r.delay && (i.delay = Zn(r.delay));
          const s = r.params;
          if (s) {
            let o = i.params;
      ...
      class al {
        ...
        buildKeyframes() {
          ...
          this._keyframes.forEach((a, l) => {
            const u = Jn(a, new Map(), this._backFill);
            u.forEach((c, d) => {
      ...
      class RD {
        ...
        build(t, n, r, i, s, o, a, l, u, c) {
          const d = [],
            ...
            Y = c ? [] : cf(t, n, this.ast.animation, s, o, p, m, j, u, d);
          let ye = 0;
          if (
            (Y.forEach((Ct) => {
          ...
          return AD(n, this._triggerName, r, i, E, p, m, Y, Et, w, y, ye);
        }
      }
      function QP(e, t) {
        const n = Vs(t);
      ...
      class uO {
        ...
        _flushAnimations(t, n) {
          ...
          for (let T = this._namespaceList.length - 1; T >= 0; T--)
            this._namespaceList[T].drainQueuedTransitions(n).forEach((F) => {
              const X = F.player,
                Le = F.element;
              if ((j.push(X), this.collectedEnterElements.length)) {
                const Ye = Le[Lt];
                if (Ye && Ye.setForMove) {
                  if (
                    ...
                    if (Bt && Bt.has(F.triggerName)) {
                      ...
                      (Fl.value = Nr), Bt.set(F.triggerName, Fl);
                    }
                  }
              ...
              const mn = !d || !this.driver.containsElement(d, Le),
                St = y.get(Le),
                nr = p.get(Le),
                ve = this._buildInstruction(F, r, nr, St, mn);
              if (ve.errors && ve.errors.length) return void Y.push(ve);
              if (mn)
                return (
                  X.onStart(() => wr(Le, ve.fromStyles)),
                  X.onDestroy(() => pn(Le, ve.toStyles)),
                  void i.push(X)
                );
              ...
              ve.timelines.forEach((Ye) => {
                ...
                o.push({ instruction: ve, player: X, element: Le }),
                ve.queriedElements.forEach((Ye) => Dt(a, Ye, []).push(X)),
                ve.preStyleProps.forEach((Ye, Nr) => {
                  if (Ye.size) {
                    let Bt = l.get(Nr);
                    Bt || l.set(Nr, (Bt = new Set())),
                      Ye.forEach((Fl, nh) => Bt.add(nh));
                  }
                }),
                ve.postStyleProps.forEach((Ye, Nr) => {
                  let Bt = u.get(Nr);
                  Bt || u.set(Nr, (Bt = new Set())),
                    Ye.forEach((Fl, nh) => Bt.add(nh));
                });
            });
          if (Y.length) {
          ...
          o.forEach((T) => {
            ...
            i.forEach((T) => {
              ...
              this._getPreviousPlayers(
                ...
                Dt(ye, N, []).push(X), X.destroy();
              });
            });
          const Ct = m.filter((T) => VD(T, l, u)),
            bt = new Map();
          FD(bt, this.driver, w, u, An).forEach((T) => {
            VD(T, l, u) && Ct.push(T);
          });
          const Pn = new Map();
          h.forEach((T, N) => {
            FD(Pn, this.driver, new Set(T), l, "!");
          }),
            Ct.forEach((T) => {
              const N = bt.get(T),
                F = Pn.get(T);
          ...
          const rn = [],
            ...
            Fi = {};
          o.forEach((T) => {
            const { element: N, player: F, instruction: X } = T;
            if (r.has(N)) {
              if (c.has(N))
                return (
                  F.onDestroy(() => pn(N, X.toStyles)),
                  (F.disabled = !0),
              ...
              if (Et.size > 1) {
                ...
                nr.forEach((ve) => Et.set(ve, Le));
              }
              const mn = this._buildAnimation(F.namespaceId, X, ye, s, Pn, bt);
              if ((F.setRealPlayer(mn), Le === Fi)) rn.push(F);
              else {
                const St = this.playersByElement.get(Le);
                St && St.length && (F.parentPlayer = Yn(St)), i.push(F);
              }
            } else
              wr(N, X.fromStyles),
                F.onDestroy(() => pn(N, X.toStyles)),
          ...
          for (let T = 0; T < m.length; T++) {
            ...
            if (a.size) {
              ...
              for (let nr = 0; nr < St.length; nr++) {
                let ve = a.get(St[nr]);
                ve && ve.length && X.push(...ve);
              }
            }
            const Le = X.filter((mn) => !mn.destroyed);
          ...
          const a = n.triggerName,
            ...
            f = n.timelines.map((p) => {
              ...
              const _ = g !== l,
                ...
                Y = this._buildPlayer(p, j, w);
              if ((p.subTimeline && i && d.add(g), _)) {
                const ye = new yf(t, a, g);
                ye.setRealPlayer(Y), u.push(ye);
              }
              return Y;
            });
          u.forEach((p) => {
          ...
          destroy() {
            this.finish(),
              this._state < 3 &&
                ...
                this._startStyles &&
                  (wr(this._element, this._startStyles),
                  (this._endStyles = null)),
                this._endStyles &&
                  (wr(this._element, this._endStyles),
                  (this._endStyles = null)),
                pn(this._element, this._initialStyles),
                (this._state = 3));
          }
      ...
      let IO = (() => {
        ...
        return (
          (e.ɵfac = function (n) {
            return new (n || e)(M(Fe), M(Xd), M(ff), M(As));
          }),
          (e.ɵprov = k({ token: e, factory: e.ɵfac })),
          e
        );
      ...
      function nn(e, t) {
        return "function" == typeof t
          ? (n) =>
              n.pipe(
                nn((r, i) => ke(e(r, i)).pipe(ee((s, o) => t(r, s, i, o))))
              )
          : (n) => n.lift(new jO(e));
      }
      class jO {
      ...
      class JO extends he {
        constructor(t, n, r, i) {
          super(t),
            (this._tapNext = er),
            (this._tapError = er),
            (this._tapComplete = er),
            (this._tapError = r || er),
            (this._tapComplete = i || er),
            rr(n)
              ? ((this._context = this), (this._tapNext = n))
              : n &&
                ((this._context = n),
                (this._tapNext = n.next || er),
                (this._tapError = n.error || er),
                (this._tapComplete = n.complete || er));
        }
        _next(t) {
          try {
      ...
      class Ar {
        constructor(t, n, r, i, s, o, a, l) {
          (this.url = t),
            ...
            (this.outlet = o),
            (this.component = a),
            (this.title = this.data?.pipe(ee((u) => u[Us])) ?? R(void 0)),
        ...
        get paramMap() {
          return (
            this._paramMap ||
              (this._paramMap = this.params.pipe(ee((t) => Ti(t)))),
            this._paramMap
          );
        }
        get queryParamMap() {
          return (
            this._queryParamMap ||
              (this._queryParamMap = this.queryParams.pipe(ee((t) => Ti(t)))),
            this._queryParamMap
          );
        }
        toString() {
      ...
      function Lf(e, t) {
        const n =
          ...
          (function w1(e, t) {
            return (
              Tr(e, t) && e.every((n, r) => gn(n.parameters, t[r].parameters))
            );
          })(e.url, t.url);
        return (
          n &&
                ...
                const l = (function mF(e, t, n) {
                  ...
                  switch (n) {
                    ...
                    case "pathParamsOrQueryParamsChange":
                      return (
                        !Tr(e.url, t.url) || !gn(e.queryParams, t.queryParams)
                      );
                    case "always":
                      return !0;
        ...
        return s.matched
          ? (function PF(e, t, n, r) {
              ...
              return i && 0 !== i.length
                ...
                : R(!0);
            })((r = Aw(t, r)), t, n).pipe(ee((o) => (!0 === o ? s : { ...Hf })))
          : R(s);
      }
      function Uf(e, t, n) {
        if ("" === t.path)
      ...
      class $F {
        ...
        match(t) {
          return this.expandSegmentGroup(this.injector, this.config, t.root, G)
            .pipe(
              ee((i) => this.createUrlTree(vl(i), t.queryParams, t.fragment))
            )
            .pipe(
              br((i) => {
        ...
        expandSegmentGroup(t, n, r, i) {
          return 0 === r.segments.length && r.hasChildren()
            ? this.expandChildren(t, n, r).pipe(ee((s) => new q([], s)))
                      ...
                      ? this.getChildConfig((t = r._injector ?? t), r, i).pipe(
                          $e((c) => {
                            ...
                            return this.expandSegment(
                              ...
                              ee((w) => new q(a.concat(w.segments), w.children))
                            );
                          })
                        )
                      : to(n)
      ...
      let yL = (() => {
          ...
          preloadConfig(n, r) {
            return this.preloadingStrategy.preload(r, () => {
              ...
              return r.loadComponent && !r._loadedComponent
                ? ke([s, this.loader.loadComponent(r)]).pipe(Pr())
                : s;
            });
          }
        }
        return (
          (e.ɵfac = function (n) {
            return new (n || e)(M(Be), M(ad), M(Bn), M(Yw), M(Gf));
          }),
          (e.ɵprov = k({ token: e, factory: e.ɵfac, providedIn: "root" })),
          e
        );
          ...
          static forRoot(n, r) {
            return {
              ...
              providers: [
                ...
                r?.useHash
                  ? { provide: _r, useClass: pR }
                  : { provide: _r, useClass: p_ },
                {
                  provide: Qf,
                  useFactory: () => {
                    const e = be(Be),
      ...
      function kL(e, t) {
        if ((1 & e && (S(0, "div"), ue(1, LL, 1, 0, "div", 6), A()), 2 & e)) {
          const n = _t(2);
          ca(n.spinner.class),
            yi("color", n.spinner.color),
            se(1),
            J("ngForOf", n.spinner.divArray);
        }
      }
      function VL(e, t) {
        1 & e &&
          ...
          (function nv(e, t) {
            ...
            n.firstCreatePass
              ...
              : (r = n.data[i]);
            const s = r.factory || (r.factory = lr(r.type)),
              o = It(I);
            try {
              const a = No(!1),
                l = s();
      ...
      function jL(e, t) {
        if (
          ...
          yi("background-color", n.spinner.bdColor)(
            ...
            J("@.disabled", n.disableAnimation)("@fadeIn", "in"),
            se(2),
            J("ngIf", !n.template),
            se(1),
            J("ngIf", n.template),
      ...
      let HL = (() => {
        ...
        UL = (() => {
          ...
          return (
            (e.ɵfac = function (n) {
              return new (n || e)(I(sE), I(Sa), I(qt), I(oE, 8));
            }),
            (e.ɵcmp = Ue({
              type: e,
          ...
          class e {
            ...
            scroll(n) {
              console.log(`scrolling to ${n}`),
                document.getElementById(n)?.scrollIntoView(!0);
            }
          }
          return (
            (e.ɵfac = function (n) {
            ...
            (e.ɵcmp = Ue({
              ...
              consts: [
                ...
                ["href", "#contact"],
                ["href", "#skills"],
                ["href", "#education", 3, "click"],
                ["href", "#experience", 3, "click"],
              ],
              template: function (n, r) {
                1 & n &&
                  (S(0, "div", 0)(1, "div", 1)(2, "a", 2),
                  Un("click", function () {
                    return r.gotoTop();
                  }),
                  ge(3, "i", 3),
                  ...
                  S(8, "a", 6),
                  Un("click", function () {
                    return r.scroll("education");
                  }),
                  Q(9, "Education"),
                  A(),
                  S(10, "a", 7),
                  Un("click", function () {
                    return r.scroll("experience");
                  }),
                  Q(11, "Experience"),
                  A()());
              },
              styles: [
                ".topnav[_ngcontent-%COMP%]{background-color:#333;overflow:hidden;position:sticky;top:0;z-index:100;height:50px}.topnav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{float:right;color:#f2f2f2;text-align:center;padding:14px 16px;text-decoration:none;font-size:17px;transition:.4s}.topnav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{background-color:#ddd;color:#000}.topnav[_ngcontent-%COMP%]   a.active[_ngcontent-%COMP%]{background-color:#04aa6d;color:#fff}.home[_ngcontent-%COMP%]{background-color:#04aa6d;float:left}.scroll-with-offset[_ngcontent-%COMP%]{padding-top:100px;margin-bottom:-100px}",
              ],
            })),
            e
          );
        ...
        GL = (() => {
          ...
          return (
            ...
            (e.ɵcmp = Ue({
              ...
              template: function (n, r) {
                1 & n &&
                  (S(0, "div", 0)(1, "div", 1)(2, "p", 2),
                  Q(3, "Created by Bruno Omizu - 2022"),
                  A()()());
              },
              styles: [
            ...
            (e.ɵcmp = Ue({
              ...
              template: function (n, r) {
                1 & n &&
                  ...
                  ge(2, "img", 2),
                  A(),
                  S(3, "div", 3)(4, "div", 4)(5, "h1"),
                  Q(6, "Bruno Omizu"),
                  A(),
                  S(7, "p"),
                  Q(8, "Solutions Architect | Technical Lead"),
                  A(),
                  S(9, "p"),
                  Q(10, "New Zealand Permanent Resident"),
                  A()(),
                  S(11, "div", 5)(12, "div")(13, "h4")(14, "strong"),
                  Q(15, "Phone"),
                  A()(),
                  S(16, "p"),
                  Q(17, "000 222 8877"),
                  A()(),
                  S(18, "div")(19, "h4")(20, "strong"),
                  Q(21, "Email"),
                  A()(),
                  S(22, "p"),
                  Q(23, "test@test.com"),
                  A()(),
                  S(24, "div")(25, "h4")(26, "strong"),
                  Q(27, "Address"),
                  A()(),
                  S(28, "p"),
                  Q(29, "19/8 TEST TEST"),
                  ...
                  Q(33, "TEST"),
                  A()(),
                  S(34, "div")(35, "h4")(36, "strong"),
                  Q(37, "Date of Birth"),
                  A()(),
                  S(38, "p"),
                  Q(39, "November 12th, 1985"),
                  A()()()()(),
                  S(40, "div", 6)(41, "div", 7)(42, "div", 8)(43, "a", 9),
                  ge(44, "i", 10),
                  A()(),
                  S(45, "div", 8)(46, "a", 11),
                  ge(47, "i", 12),
                  ...
                  ge(53, "i", 16),
                  A()()()(),
                  S(54, "div", 17)(55, "div", 18)(56, "div", 19)(57, "span"),
                  Q(58, "Hello, I'm Bruno"),
                  A()(),
                  S(59, "p"),
                  Q(
                    60,
      ...
      function ZL(e, t) {
        if (
          (1 & e &&
            (S(0, "div", 8), pr(1, 1), ue(2, YL, 1, 0, "ng-container", 6), A()),
          2 & e)
        ) {
          const n = _t();
          se(2), J("ngTemplateOutlet", n.headerTemplate);
        }
      }
      function JL(e, t) {
        1 & e && dn(0);
      ...
      function XL(e, t) {
        if (
          (1 & e &&
            (S(0, "div", 9), Q(1), ue(2, JL, 1, 0, "ng-container", 6), A()),
          2 & e)
        ) {
          const n = _t();
          se(1),
            Ds(" ", n.header, " "),
            se(1),
            J("ngTemplateOutlet", n.titleTemplate);
        }
      }
      function ek(e, t) {
        1 & e && dn(0);
      ...
      function tk(e, t) {
        if (
          (1 & e &&
            (S(0, "div", 10), Q(1), ue(2, ek, 1, 0, "ng-container", 6), A()),
          2 & e)
        ) {
          const n = _t();
          se(1),
            Ds(" ", n.subheader, " "),
            se(1),
            J("ngTemplateOutlet", n.subtitleTemplate);
        }
      }
      function nk(e, t) {
        1 & e && dn(0);
      ...
      function ik(e, t) {
        if (
          ...
          const n = _t();
          se(2), J("ngTemplateOutlet", n.footerTemplate);
        }
      }
          ...
          return (
            ...
            (e.ɵcmp = Ue({
              ...
              contentQueries: function (n, r, i) {
                if (
                  (1 & n && (yr(i, KL, 5), yr(i, QL, 5), yr(i, Ol, 4)), 2 & n)
                ) {
                  let s;
              ...
              template: function (n, r) {
                1 & n &&
                  ...
                  2 & n &&
                    (ca(r.styleClass),
                    J("ngClass", "p-card p-component")("ngStyle", r.style),
                    se(1),
                    J("ngIf", r.headerFacet || r.headerTemplate),
                    se(2),
                    J("ngIf", r.header || r.titleTemplate),
                    se(1),
                    J("ngIf", r.subheader || r.subtitleTemplate),
                    se(3),
                    J("ngTemplateOutlet", r.contentTemplate),
                    se(1),
                    J("ngIf", r.footerFacet || r.footerTemplate));
              },
      ...
      function ck(e, t) {
        if (
          ...
          const n = _t().$implicit,
            r = _t();
          se(1),
            J("ngTemplateOutlet", r.markerTemplate)(
      ...
      function pk(e, t) {
        if (
          ...
          const n = t.$implicit,
            ...
            s = _t();
          se(2),
            J("ngTemplateOutlet", s.oppositeTemplate)(
              "ngTemplateOutletContext",
              ya(7, th, n)
            ),
            se(2),
            J("ngIf", s.markerTemplate)("ngIfElse", i),
            se(3),
            J("ngIf", !r),
            se(2),
            J("ngTemplateOutlet", s.contentTemplate)(
              "ngTemplateOutletContext",
              ya(9, th, n)
            );
        }
      ...
      let mk = (() => {
          ...
          return (
            ...
            (e.ɵcmp = Ue({
              ...
              template: function (n, r) {
                1 & n && (S(0, "div", 0), ue(1, pk, 10, 11, "div", 1), A()),
                  2 & n &&
                    (ca(r.styleClass),
                    J("ngStyle", r.style)(
                      "ngClass",
      ...
      function vk(e, t) {
        if ((1 & e && (S(0, "span"), ge(1, "i", 6), A()), 2 & e)) {
          const n = t.$implicit;
          se(1), yi("color", n.color), J("ngClass", n.icon);
        }
      }
      function _k(e, t) {
        if ((1 & e && (S(0, "a", 10), ge(1, "img", 11), A()), 2 & e)) {
          const n = _t().$implicit;
          J("href", n.url, os), se(1), J("alt", n.company)("src", n.image, os);
        }
      }
      function Dk(e, t) {
        if (
          ...
          const n = t.$implicit;
          J("header", n.company)("subheader", n.date), se(3), Vc(n.description);
        }
      }
      let wk = (() => {
        class e {
          ...
          (e.ɵcmp = Ue({
            ...
            template: function (n, r) {
              1 & n &&
                ...
                Q(3, "EXPERIENCE"),
                A()(),
                S(4, "div", 2)(5, "p-timeline", 3),
                ue(6, vk, 2, 3, "ng-template", 4),
                ue(7, Dk, 4, 3, "ng-template", 5),
                A()()),
                2 & n && (se(5), J("value", r.events));
            },
            dependencies: [ja, eh, Ol, mk],
            styles: [
              ".flex-container-experience-box[_ngcontent-%COMP%]{width:100%;margin-left:auto;margin-right:auto}",
            ],
          })),
          e
        );
          ...
          (e.ɵcmp = Ue({
            ...
            template: function (n, r) {
              1 & n &&
                ...
                Q(3, "EDUCATION"),
                A()(),
                S(4, "div", 2)(5, "p-card", 3),
                ue(6, Ek, 2, 0, "ng-template", 4),
                S(7, "p"),
                Q(
                  8,
            ...
            dependencies: [eh, Ol],
            styles: [
              ".flex-container-experience-box[_ngcontent-%COMP%]{margin-left:auto;margin-right:auto;display:flex;flex-direction:row;align-items:center;justify-content:center}",
            ],
          })),
          e
        );
      ...
      function Ik(e, t) {
        if (
          (1 & e && (S(0, "p-card", 4), ue(1, Sk, 1, 0, "i", 5), A()), 2 & e)
        ) {
          const n = t.$implicit,
            r = _t();
          Pt(qc(5, Tk)),
            J("header", n.name)("subheader", n.description),
            se(1),
            J("ngForOf", r.starsArray(n.stars));
        }
      }
      let Mk = (() => {
          class e {
            ...
            (e.ɵcmp = Ue({
              ...
              template: function (n, r) {
                1 & n &&
                  ...
                  A()),
                  2 & n && (se(5), J("ngForOf", r.skills));
              },
              dependencies: [Ba, eh],
              styles: [
                ".flex-container-skills-box[_ngcontent-%COMP%]{margin-left:400px;margin-right:400px;display:flex;flex-direction:row;flex-wrap:wrap;align-items:center;justify-content:center}p-card[_ngcontent-%COMP%]{width:300px;margin:10px}",
              ],
            })),
            e
          );
        ...
        Rk = (() => {
          ...
          return (
            ...
            (e.ɵcmp = Ue({
              ...
              template: function (n, r) {
                1 & n &&
                  (S(0, "ngx-spinner", 0)(1, "p", 1),
                  Q(2, "Loading..."),
                  A()(),
                  ge(3, "app-header")(4, "app-main-page"),
                  S(5, "section", 2),
                  ge(6, "app-experience")(7, "app-education"),
                  A(),
                  ge(8, "app-skills")(9, "app-contact")(10, "app-footer")),
                  2 & n && J("fullScreen", !0);
              },
